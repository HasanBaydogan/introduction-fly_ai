...
[Adınız]`,
  ...
  problemSolution: {
    ...
    bannerText:
      "Destek Merkezi (chat), çoklu para birimi, banka seçimleri, dosya yükleme ve statü tabanlı aşamalarla süreçlerinizi net, hızlı ve izlenebilir yönetin.",
  },
  features: {
    ...
    items: [
      {
        ...
        icon: "/folded-map.svg",
        description:
          "RFQ → Quote → PO → PI → Ödeme → Taşıma → Gümrük → Teslimat akışını tek ekranda yönetin.",
      },
      {
        title: "Şeffaf ilerleme",
        icon: "/manage.svg",
        description: "Durum sekmeleri ve rozetlerle görsel akış takibi; herkes aynı sayfada.",
      },
      {
        title: "Daha hızlı koordinasyon",
        icon: "/user.svg",
        description: "Dahili Destek Merkezi ile sohbet tabanlı yazışma ve dosya paylaşımı.",
      },
      {
        title: "Finansal uyum",
        icon: "/calendar.svg",
        description: "Çoklu para birimi ve banka bilgileriyle PI düzenleme ve ödeme takibi.",
      },
      {
        title: "Risk azaltma",
        icon: "/star.svg",
        description: "İptal/iade için ayrı aşamalar ve onay mekanikleri ile güvenli süreç.",
      },
      {
        title: "Verimlilik",
        icon: "/tech.svg",
        description: "Toplu arama, filtreleme, dosya yükleme ve inline düzenleme.",
      },
    ],
  },
  guide: {
  ...
  faq: {
    ...
    heading: "SSS",
    subtitle:
      "Havacılık Tedarik Yönetim Aracımız hakkında en sık sorulan soruları yanıtladık. Diğer sorularınız için bizimle iletişime geçmekten çekinmeyin.",
  ...
  contact: {
    ...
    name: "İsim",
    surname: "Soyisim",
    nameRequired: "Lütfen isminizi ve soyisminizi yazınız",
    namePlaceholder: "İsminizi ve soyisminizi yazınız...",
    email: "E-Posta",
    emailRequired: "E-posta adresinizi giriniz.",
    emailErrorMessage: "Geçerli bir e-posta adresi giriniz.",
    subject: "Konu",
    subjectRequired: "Lütfen bir konu giriniz.",
    ...
    phoneErrorMessage: "Geçerli bir telefon numarası giriniz.",
    message: "Mesaj",
    messageRequired: "Mesajınızı giriniz.",
